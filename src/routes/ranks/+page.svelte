...
<main>
  <header>
    <a href="/">
      <svg xmlns="http://www.w3.org/2000/svg" aria-label={$t('home.title')} class="icon icon-tabler icon-tabler-arrow-left" width="48" height="48" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
